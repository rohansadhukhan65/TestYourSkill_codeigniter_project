...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-6">
            <h4 class="page-title font-weight-light">Student Results</h4>
...
<div class="container">
    <div class="card shadow p-5" style="border-radius: 10px;">
        ...
        ============================ -->
        <div class="mr-auto">
            <a href="result_details" class="text-info  font-weight-light py-1"><i class="fas fa-sync"></i> Refresh Table</a>
        </div>
        <!-- Refresh Button -->


        <!-- Search Result ByStudent name
        ============================================== -->
        <form action="student_result_search" method="POST" class="d-flex ml-auto form-inline">
        ...
        <!-- Search Result ByStudent name End -->
                ...
                <table class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr class="bg-primary">
                            ...
                            <th scope="col" style="color: white;">Topic</th>
                    ...
                    <tbody>
                        ...
                        foreach ($std_result as $row) {  ?>
                            <tr>
                                ...
                                <th>
                                    <a href="delete_student_result?id=<?php echo $row->std_id ?>" type="button" class="btn-outline-danger btn-sm" style="text-decoration: none;">
                                        Delete
                                    </a>
                                </th>
                            </tr>
